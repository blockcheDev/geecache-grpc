...
type GroupCacheClient interface {
	Get(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*GroupReply, error)
}
...
func (c *groupCacheClient) Get(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*GroupReply, error) {
	out := new(GroupReply)
...
type GroupCacheServer interface {
	Get(context.Context, *GroupRequest) (*GroupReply, error)
...
func (UnimplementedGroupCacheServer) Get(context.Context, *GroupRequest) (*GroupReply, error) {
...
func _GroupCache_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupCacheServer).Get(ctx, req.(*GroupRequest))
	}
...
var GroupCache_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "GeeCache/groupcachepb/groupcachepb.proto",
}
